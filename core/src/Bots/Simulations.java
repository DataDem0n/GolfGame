...
//
///**
// * Simulations end game by checking many paths
// */
...
//    private PathCalculator pathCalc;                            //maybe use the same pathcalc of the plot object.
...
//     */
//
//    public Simulations(BiFunction<Double,Double,Double> terrain, double interval, AdjacencyField adjacency, SlopeField slope, double ballCoorX, double ballCoorY, double sFriction, double kFriction, Plot plotter, PathCalculator pathCalc)
//    {
...
//
//
//        correctShot = plotter.getCorrectShot(pathCalc.pathX, pathCalc.pathY,ballCoorX,ballCoorY);
//
