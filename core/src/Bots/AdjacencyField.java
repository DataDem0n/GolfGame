...
//
//
////    public int[][] floodFillUpdateWater()                 //rivers                                  //convergence to box fucks up, if there are 2 lakes (2 places with water)
////    {
////        int[][] field = Field();
////
////        for(int i = 0; i < field.length; i++)
...
////            for(int j = 0; j < field[0].length; j++)
////            {
////                if(terrain.apply(i/interval-25, j/interval-25) < 0)                 //made water bigger, so the error doesnt land into it
////                {
////                    field[i][j] = -1;           //10000
////                }
////            }
...
//    {
//        BiFunction<Double,Double,Double> terrain = (x,y)->(double)Math.sin(x+y);            //the terrain (so the ai detects water)
